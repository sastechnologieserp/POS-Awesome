...
doc_events = {
	"Sales Invoice": {
		"before_insert": "posawesome.posawesome.api.invoice.before_insert",
		...
		"filters": [
			[
				...
				(
					...
					"POS Profile-posa_cart_table_settings_section",
					"POS Profile-posa_cart_table_col_break_1",
					"POS Profile-posa_cart_table_col_break_2",
					"POS Profile-posa_display_uom",
					"POS Profile-posa_display_offer_column",
					"POS Profile-posa_display_price_list_rate",
					"POS Profile-posa_display_available_qty",
					"POS Profile-posa_display_item_group",
					"POS Profile-posa_display_stock_qty",
					"POS Profile-posa_display_stock_uom",
					"POS Profile-posa_display_warehouse",
					"POS Profile-posa_display_price_list_rate_bottom",
					"POS Profile-posa_allow_user_to_edit_qty",
					"POS Profile-posa_allow_user_to_edit_uom",
					...
					"POS Profile-posa_enable_print_preview_overlay",
					...
					"POS Profile-posa_qty_has_decimal",
